...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-[#5B7FE8] via-[#4A6FD8] to-[#3A5FC8] text-white py-16 sm:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 text-center z-10">
        <h1 className="font-poppins text-4xl sm:text-5xl lg:text-6xl font-light mb-6 leading-tight tracking-wide text-[#ffffff]">
          Welcome to the
          <br />
          <span className="font-semibold mt-2 inline-block">Filipino Apostolate of Boston</span>
        </h1>
        
        <p className="text-lg sm:text-xl lg:text-2xl mb-12 leading-relaxed font-light max-w-4xl mx-auto text-[#ffffff]">
